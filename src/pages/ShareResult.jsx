    ...
    <div className="min-h-screen px-4 py-8 md:py-12">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="text-center mb-6">
          <span className="inline-block px-4 py-1.5 rounded-full text-xs font-medium bg-white/[0.06] t-secondary mb-4">
        ...
        >
          ...
          <div className="p-6">
            <p className="t-secondary text-sm leading-relaxed mb-4">{meta.description}</p>
            <div className="flex justify-center gap-6">
              <div>
                <div className="text-2xl font-bold t-primary">{data.score_total}</div>
                <div className="text-xs t-muted">설문 / 45</div>
              </div>
              <div className="w-px bg-white/[0.06]" />
              <div>
                <div className="text-2xl font-bold t-primary">{data.quiz_score}</div>
                <div className="text-xs t-muted">퀴즈 / 10</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="text-center">
          <button
            onClick={() => navigate('/')}
            className="px-8 py-3 rounded-xl font-bold text-white btn-gradient"
          >
            나도 응시하기
          </button>
        </div>
